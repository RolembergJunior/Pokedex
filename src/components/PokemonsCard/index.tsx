...
export default function PokemonCard({
  ...
  const typeName2 = pokemonsTypes[secondType] as string;
  ...
  return (
    <div
      onClick={() => handleAboutPokemons(id)}
      style={cardStyle}
      className="relative bg-gradient-to-t from-black to-gray-800 flex flex-col justify-around cursor-pointer border p-6 mr-4 ml-4 mb-5 w-[300px] h-[500px] rounded-lg hover:p-6 hover:transition-all dark:bg-slate-200 hover:dark:bg-slate-500"
      key={id}
    >
      ...
      <div className="flex justify-around">
        <div
          style={backgroundColor}
          className="flex justify-center bg-red-600 w-20 rounded-sm text-white"
        >
